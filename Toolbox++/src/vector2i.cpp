...
Vector2 Vector2i::Rotate(const float angle, const Vector2 center) const
{
	float c = cos(angle);
	float s = sin(angle);
...
Vector2 Vector2i::Rotate(const Vector2 center, const float cos, const float sin) const
{
