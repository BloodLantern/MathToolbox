...
namespace Calc
{
	...
	/// @returns Whether the values are considered equal.
	[[nodiscard]]
	PUBLIC_API bool_t Equals(const Matrix2& a, const Matrix2& b) noexcept;
	...
	/// @returns Whether the values are considered equal.
	[[nodiscard]]
	PUBLIC_API bool_t Equals(const Matrix3& a, const Matrix3& b) noexcept;
	...
	/// @returns Whether the values are considered equal.
	[[nodiscard]]
	PUBLIC_API bool_t Equals(const Matrix& a, const Matrix& b) noexcept;
	...
	/// @returns Whether the values are considered equal.
	[[nodiscard]]
	PUBLIC_API bool_t Equals(const Quaternion& a, const Quaternion& b) noexcept;
